...
public class PieChartUtil {
    ...
    public  final int[]  PIE_COLORS={
            Color.rgb(154, 2, 248),Color.rgb(255, 255, 0),Color.rgb(236, 161, 62),
            Color.rgb(154, 2, 248)
    };
    public  final int[]  PIE_COLORS2={
            Color.rgb(154, 2, 248),Color.rgb(255, 255, 0),  Color.rgb(154, 2, 248),
            Color.rgb(192, 255, 155)
    };
    ...
    public void setPieChart(PieChart pieChart, Map<String, Float> pieValues, String title, boolean showLegend) {
        ...
        pieChart.setCenterTextColor(PIE_COLORS2[3]);
    ...
    private void setPieChartData(PieChart pieChart, Map<String, Float> pieValues) {
        ...
        if (title.equals("常驻祈愿"))
        dataSet.setColors(PIE_COLORS);//设置饼块的颜色
        else
            dataSet.setColors(PIE_COLORS2);
