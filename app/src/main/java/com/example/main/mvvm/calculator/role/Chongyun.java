...
public class Chongyun extends Obj_calculator{
    public Chongyun(Jszsg.AvatarInfoListDTO jszsg, List<Bl_cl> bl_cl, CharacterData du, Context context) {
    ...
    public void user_mz(int mz) {
        switch (mz){
            case 6:
                if (!addZy(new Zy(0.15, "6命_1", true, false, "10024", 0, 0)))
                    accumulateValue("10024", 0.15);
            case 5:
                if (e_level < 11)
                    e_level += 3;
            case 4:
