...
public class Sucrose extends Obj_calculator{
    public Sucrose(Jszsg.AvatarInfoListDTO jszsg, List<Bl_cl> bl_cl, CharacterData du, Context context) {
    ...
    public List<Sh_data> csh() {
        ...
        data.add(new Sh_data("为队友提供精通加成",new double[]{50+getYsjt(0)*0.2,0}));
        return data;
    }
