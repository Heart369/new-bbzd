...
public class Faruzan extends Obj_calculator{
    public Faruzan(Jszsg.AvatarInfoListDTO jszsg, List<Bl_cl> bl_cl, CharacterData du, Context context) {
    ...
    public List<Sh_data> csh() {
        ...
        data.add(new Sh_data("基础伤害提升",new double[]{jszsg_fb.getFightPropMap().get("4")*0.32,0}));
        return data;
    }
