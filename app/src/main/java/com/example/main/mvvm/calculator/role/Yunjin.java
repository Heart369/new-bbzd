...
public class Yunjin extends Obj_calculator {
    public Yunjin(Jszsg.AvatarInfoListDTO jszsg, List<Bl_cl> bl_cl, CharacterData du, Context context) {
    ...
    public List<Sh_data> csh() {
        ...
        data.add(new Sh_data("Q伤害提升", new double[]{getFyl(0) * getbl(q_level, 2, 1, 1)+getFyl(0)*0.075, 0}));
        return data;
    }
