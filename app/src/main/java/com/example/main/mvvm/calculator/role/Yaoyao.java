...
public class Yaoyao extends Obj_calculator{
    public Yaoyao(Jszsg.AvatarInfoListDTO jszsg, List<Bl_cl> bl_cl, CharacterData du, Context context) {
    ...
    public List<Sh_data> csh() {
        ...
        data.add(new Sh_data("Q每跳治疗量",new double[]{(getSmz(0)*getbl(q_level,2,1,2)+getbl(q_level,2,3,2)*getCure()),0}));
        return data;
    }
