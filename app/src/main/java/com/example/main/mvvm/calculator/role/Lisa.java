...
public class Lisa extends Obj_calculator{
    public Lisa(Jszsg.AvatarInfoListDTO jszsg, List<Bl_cl> bl_cl, CharacterData du, Context context) {
    ...
    public void g2() {
        if (dj>=70)
            if (!addZy(new Zy(0.15, "天赋二", false, false, "10006", getTime(), 8))) {
                accumulateValue("10006", 0.15);
            }
    }
